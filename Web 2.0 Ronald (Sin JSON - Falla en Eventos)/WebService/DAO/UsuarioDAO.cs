...
namespace WebService.DAO
{
    public class UsuarioDAO
    {
        ...
        public int AgregarUsuario(object obj)
        {
            ...
            sql = "EXEC AgregarUSUARIO '" + Usuario.Nombre + "','" + Usuario.ApPat + "','" + Usuario.ApMat + "', '" + Usuario.Contrasena + "', '" + Usuario.Usuario + "' , '" + Usuario.FotoUS + "', " + Usuario.IdMembresia + " , " + Usuario.IdTipoPago + ", " + Usuario.TipoUS + "";
        ...
        {
            UsuarioBO Usuario = (UsuarioBO)obj;
            sql = "EXEC ModifcarUSUARIO  " + Usuario.IdUsuario + " ,'" + Usuario.Nombre + "','" + Usuario.ApPat + "','" + Usuario.ApMat + "', '" + Usuario.Contrasena + "', '" + Usuario.Usuario + "' , '" + Usuario.FotoUS + "', " + Usuario.IdMembresia + " , " + Usuario.IdTipoPago + ", " + Usuario.TipoUS + "";
            return BD.Ejecutar(sql);
        }
