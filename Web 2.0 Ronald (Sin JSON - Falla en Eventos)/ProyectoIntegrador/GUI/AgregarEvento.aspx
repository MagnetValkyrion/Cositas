<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/MasterPage.Master" AutoEventWireup="true" CodeBehind="AgregarEvento.aspx.cs" Inherits="ProyectoIntegrador.GUI.AgregarEvento" %><asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
                                                ...
                                                <div class="col-md-9">   
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                         ...
                                                         <asp:TextBox ID="txtNombre" CssClass="form-control"  runat="server"  onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtNombre';}" required="" AutoPostBack="False" ></asp:TextBox>                                                     
                                            ...
                                            <div runat="server" id="ddl" class="form-group">
                                                ...
                                                <div class="col-md-9">  
                                                        ...
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                         ...
                                                         <asp:TextBox ID="txtDescripcion" CssClass="form-control"  runat="server"  onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtDescripcion';}" required="" AutoPostBack="False" ></asp:TextBox>                                                     
                                            ...
                                            <<div class="form-group"> 
                                                ...
                                                <div class="col-md-9">  
                                                        ...
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                         ...
                                                         <asp:TextBox ID="txtDireccion2" CssClass="form-control"  runat="server"  onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtDireccion';}" required="" AutoPostBack="False" ></asp:TextBox>                                                     
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">     
                                                    ...
                                                    <!--<span class="input-group-addon"><span class="fa fa-pencil"></span></span>-->
                                                     ...
                                                     <asp:TextBox ID="txtDia1" runat="server" class="form-control" value="" onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtDia1';}" required="" AutoPostBack="False"></asp:TextBox>                        
                                                        <label class="col-md-3 control-label">/</label>
                                                        <asp:TextBox ID="txtMes1" runat="server" class="form-control" value="" onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtMes1';}" required="" AutoPostBack="False"></asp:TextBox>                        
                                                        <label class="col-md-3 control-label">/</label>
                                                        <asp:TextBox ID="txtAño1" runat="server" class="form-control" value="" onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtAño1';}" required="" AutoPostBack="False"></asp:TextBox>                        
                                               ...
                                               <label class="col-md-3 control-label">Fecha Inicial</label>
                                                <div class="col-md-9">     
                                                    ...
                                                    <!--<span class="input-group-addon"><span class="fa fa-pencil"></span></span>-->
                                                     ...
                                                     <asp:TextBox ID="txtDia2" runat="server" class="form-control" value="" onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtDia2';}" required="" AutoPostBack="False"></asp:TextBox>                        
                                                        <label class="col-md-3 control-label">/</label>
                                                        <asp:TextBox ID="txtMes2" runat="server" class="form-control" value="" onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtMes2';}" required="" AutoPostBack="False"></asp:TextBox>                        
                                                        <label class="col-md-3 control-label">/</label>
                                                        <asp:TextBox ID="txtAño2" runat="server" class="form-control" value="" onfocus="this.Text = '';" onblur="if (this.Text == '') {this.Text = 'txtAño2';}" required="" AutoPostBack="False"></asp:TextBox>                        
