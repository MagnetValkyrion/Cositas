...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <img src="../../img/home/intro/screen01.png" />

                  </a>
                </li>
                <li class="thumb active">
                  <a href="#scr02" data-toggle="tab">
<img src="../../img/home/intro/screen02.png" />
                  </a>
                </li>
                <li class="thumb">
                  <a href="#scr03" data-toggle="tab">
<img src="../../img/home/intro/screen05.png" />
                  </a>
                </li>
                <li class="thumb">
                  <a href="#scr04" data-toggle="tab">
        <img src="../../img/home/intro/screen03.png" />
                  </a>
                </li>
                <li class="thumb">
            ...
            <div class="device-gallery-device">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane transition fade scale" id="scr03">
                  <img src="../../img/device-gallery/screen03.png" alt="Screen 3"/>
                </div>
                <div class="tab-pane transition fade scale" id="scr04">
                  <img src="../../img/device-gallery/screen04.png" alt="Screen 4"/>
                </div>
                <div class="tab-pane transition fade scale" id="scr05">
                  <img src="../../img/device-gallery/screen05.png" alt="Screen 5"/>
                </div>
              </div><!-- .tab-content -->
