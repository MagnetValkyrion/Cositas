...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="intro-section" style="background-image: url(../../img/home/intro/bakku01.jpg);" data-stellar-background-ratio="0.65">
      ...
      <div class="container text-center">
        ...
        <h6 class="text-thin"><b>Conoce el camino...</b></h6>
        ...
        <!-- Remove ".light-skin" class to alter appearance. -->
          ...
          <div class="col-lg-5 col-lg-offset-1 col-sm-6 padding-bottom-3x mobile-center">
            ...
            <p class="text-light opacity-50 hidden-xs" style="color:white"<b></b></p>
                <h5 style="color:white">Acompañar al turísta en su aventura a través del centro histórico de la ciudad y brindarle la mejor experiencia cultural, así como dejar huella en el visitante con el fin de promover al mundo nuestra bella ciudad.</h5>
        ...
        <div class="pricing-table">
          ...
          <div class="col-sm-6">
            ...
            <div class="box-with-image text-center">
              ...
              <div class="social-bar text-center">
                <a href="https://www.facebook.com/josepXD" class="sb-facebook" data-toggle="tooltip" data-placement="top" title="Facebook">
          ...
          <div class="col-sm-6">
            ...
            <div class="box-with-image text-center">
              ...
              <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>-->
              <div class="social-bar text-center">
                <a href="https://www.facebook.com/susii.ku " target="_blank" class="sb-facebook" data-toggle="tooltip" data-placement="top" title="Facebook">
                  <i class="fa fa-facebook"></i>
                </a>
                <a href="https://plus.google.com/u/0/110433546272404901779" target="_blank" class="sb-google-plus" data-toggle="tooltip" data-placement="top" title="Google+">
                  <i class="fa fa-google-plus"></i>
                </a>
          ...
          <div class="col-sm-6">
            ...
            <div class="box-with-image text-center">
              ...
              <h3 class="box-with-image-title"><b>Ariel Keb</b>
                <small><b>Diseñador</b></small>
              </h3>
              <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>-->
              <div class="social-bar text-center">
                <a href="https://www.facebook.com/arielito.a.garcia" target="_blank" class="sb-facebook" data-toggle="tooltip" data-placement="top" title="Facebook">
                  <i class="fa fa-facebook"></i>
                </a>
                <a href="#" class="sb-twitter" data-toggle="tooltip" data-placement="top" title="Twitter">
                  <i class="fa fa-twitter"></i>
            ...
            <div class="box-with-image text-center">
              <div class="box-with-image-image">
                <img src="../../img/team/04.jpg" alt="Johnathan Doe">
              </div>
              <h3 class="box-with-image-title"><b>Ronald Pérez</b>
                <small><b>Desarrollador</b></small>
              </h3>
              <!--<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>-->
              <div class="social-bar text-center">
                <a href="https://www.facebook.com/paradox.manrique" target="_blank" class="sb-facebook" data-toggle="tooltip" data-placement="top" title="Facebook">
                  <i class="fa fa-facebook"></i>
                </a>
                <a href="https://twitter.com/DestinyHeroR" target="_blank" class="sb-twitter" data-toggle="tooltip" data-placement="top" title="Twitter">
                  <i class="fa fa-twitter"></i>
                </a>
                <a href="https://plus.google.com/u/0/105981779531646258252" target="_blank" class="sb-google-plus" data-toggle="tooltip" data-placement="top" title="Google+">
                  <i class="fa fa-google-plus"></i>
                </a>
              <%--</div>--%>
            </div><!-- .box-with-image -->
