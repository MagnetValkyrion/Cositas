...
{
    public partial class AgregarEvento2 : System.Web.UI.Page
    {
        ...
        public void llenarDataGrid(object obj)
        {
            ...
            {
                grResultado.DataSource = servicio.DatosEventoDAO(obj);
            }
             */
            //grResultado.DataSource = servicio.BuscarEventoDAO(obj);
            grResultado.DataSource = servicio.DatosEventoDAO(obj);
        ...
        public object llenarDatos()
        {
            ...
            Evento.Nombre = txtNombre.Text;
            Evento.Descripcion = txtDescripcion.Text;
            Evento.Concurrente = Convert.ToChar(ddlEstatus.SelectedItem.Text);
            Evento.Longitud = longitude.Text;
            Evento.Latitud = latitude.Text;
            Evento.Direccion = txtDireccion.Text;
            Evento.FechaInicio = Convert.ToDateTime(TextBox1.Text);
            Evento.FechaFin = Convert.ToDateTime(TextBox2.Text);
            return Evento;
        }
